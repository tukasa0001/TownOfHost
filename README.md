...
| [Vampire/ヴァンパイア](#Vampireヴァンパイア)                                         | [Snitch/スニッチ](#Snitchスニッチ)                                         | [Fox/妖狐](#Fox妖狐)                                                       |
...
陣営 : 第三<br>
判定 : クルーメイト<br>
勝利条件 : 全インポスターの排除、或いは生存プレイヤーの過半数がインポスターになった時点で生存していること。<br>

ゲーム終了時点まで生存していることで単独勝利します。<br>
第三陣営勝利とインポスターのサボタージュ勝利の場合のみ敗北となります。(ジャッカル勝利を除く)<br>
また、妖狐が生存している間、クルーはタスクを終えても勝利できません。<br>
全クルーがタスクを終えた状態で妖狐を排除した場合、インポスターの人数に依らずクルーのタスク勝利になります。<br>

設定によりシェリフが妖狐をキルできます。<br>
その他のプレイヤーによって妖狐はキルされません。<br>
妖狐に攻撃したプレイヤーは、設定値の半分までキルクールが追加されます。<br>

妖狐は通常のクルーよりも視界が狭く、あらゆるサボタージュを直すことができません。<br>
