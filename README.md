...
**3.0.2.3(最新バージョン)は[こちら](https://github.com/Yumenopai/TownOfHost_Y/releases/tag/v3.0.2.3)から**<br>
本家TOHの対応バージョンは[こちら](https://github.com/tukasa0001/TownOfHost/releases/tag/v3.0.2)<br>
...
>TOH_Yでの変更<br>
>「幽霊が他人の役職・投票先を見ることができる」→「幽霊が他人の役職・投票先を見ることができない」に変更<br>
