...
[Discord](https://discord.gg/PekjJscTT6)

## リリース

AmongUsバージョン : **2022.10.25**
**本家TOHの対応最新バージョンはこちら(https://github.com/tukasa0001/TownOfHost/releases/latest)**
...
| [ヴァンパイア](#Vampireヴァンパイア)                                 | [スニッチ](#Snitchスニッチ)                                 | アンチコンプリート                                           |           |  |
| [ウォーロック](#Warlockウォーロック)                                 | [スピードブースター](#SpeedBoosterスピードブースター)       | ワーカホリック　                                              |           |
| [魔女](#Witch魔女)                                                   | [トラッパー](#Trapperトラッパー)                            |                                                             |           |
| [マフィア](#Mafiaマフィア)                                           | ハンター                                                    |                                                             |           |
| [マッドメイト](#Madmateマッドメイト)                                 | タスクマネージャー                                            |                                                             |           |
| [マッドガーディアン](#MadGuardianマッドガーディアン)                 | パン屋                                                     |                                                             |           |
| [マッドスニッチ](#MadSnitchマッドスニッチ)                           | エクスプレス                                                 |                                                             |           |
| [サイドキックマッドメイト](#SidekickMadmateサイドキックマッドメイト) | チェアマン                                                   |                                                             |           |
| アンチアドミナー                                                   | ★にじいろスター★                                            |                                                             |           |
| イビル猫又                                                         | 猫又                                           |                                                             |           |
| マッドディクテーター                                                        | 見送り人                            |                                                             |           |
| マッドネイチャコール                                                        | 　　　　                            |                                                             |           |
...
クルーの[ディクテータ](#Dictator/ディクテーター)と仕様は同じ。<br>
...
#### 注意
インポスターが1の時、暗転対策として必ず同数投票と表示される仕様により、見送り人は使用不可となる。<br>
