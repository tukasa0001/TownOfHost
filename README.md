...
また、以下の設定は Town Of Host 内の設定項目をお使いいただき、元々の設定の値を０にしてください。<br>

- キルクールタイム（インポスターの役職設定項目内）
- 変身クールダウン（シェイプシフターの役職設定項目内）
...
| [Madmate/マッドメイト](###Madmate/マッドメイト)                       | [Doctor/ドクター](###Doctor/ドクター)                                         |                                                                               |
...
陣営 : 第三<br>
判定 : クルーメイト<br>
勝利条件 : ターゲットが投票で追放される<br>

ターゲットに対してこちらからのみ視認できるダイヤのマークがついています。<br>
投票でダイヤが付いている人を追放すれば単独勝利。<br>
