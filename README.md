...
一部の属性は共通のアサイン設定を持っています。
属性によっては、アサインされない陣営があります。
...
1. 確率と「最大数」から全体アサイン数を決定
2. 各陣営ごとに、最大アサイン数の制約に従い、アサイン対象となる役職のプレイヤーを選出
3. その中から全体アサイン数の制約に従い、ランダムにアサイン先を決定する
...
2. インポスター陣営（n人）全員にアサイン
   最大数: n, 最大アサイン数: (0, n, 0)

3. ジャッカル（1人）に固定的にアサイン
