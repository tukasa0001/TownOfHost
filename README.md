...
| [マフィア](#Mafiaマフィア)                                           | [占い師](#FortuneTeller占い師)                              |                                                             |           |
...
投票することで他の人の役職を占うことができます。<br>
見る事ができるのはキルできる役職のみ。（インポスター系、エゴイスト、ジャッカル）<br>
会議で投票を行うと次の会議で占い結果を確認できます。<br>
次の会議までに占った相手が死ぬと占いは無効になります。<br>
以下の条件を満たしたときに占うことができます。（設定）<br>
　・自分のタスクが一定数完了していること<br>
　・死亡者がでること<br>
