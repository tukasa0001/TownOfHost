...
ターゲットではない人をキルした場合も、キルクールはそのまま維持されます。<br>
...
魔術をかけられた人には会議で特殊なマークが付き、その会議中に魔女を追放することができなければ死亡してしまいます。
...
| 設定名 |
|----------|
| マッドメイト(マッドガーディアン)が停電を直すことができる/Madmate(MadGuardian) Can Fix Lights Out |
...
キルされたときに、自分をキルした人に強制的に自分の死体を通報させることができる役職です。<br>
...
メイヤーは票を複数持っており、まとめて一人またはスキップに入れることができます。<br>
