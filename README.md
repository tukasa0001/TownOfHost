...
### DarkScientist/ダークサイエンティスト

陣営 : インポスター<br>
判定 : 科学者<br>

インポスター陣営に属しますが、ダークサイエンティストからはインポスターが誰なのかはわかりません。<br>
インポスターからもダークサイエンティストが誰なのかはわかりません。<br>
しかし、時間制限なしでバイタルを見る事ができます。<br>
キルやサボタージュはできず、通気口に入ることもできません。<br>
