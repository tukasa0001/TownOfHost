    ...
    class ChatCommands
    {
        ...
        public static void getRolesInfo(string role)
        {
            switch (role)
            {
                ...
                case "timethief":
                case "tt":
                    Utils.SendMessage(Utils.getRoleName(CustomRoles.TimeThief) + getString("TimeThiefInfoLong"));
                    break;
