    ...
    class ChatCommands
    {
        ...
        public static void getRolesInfo(string role)
        {
            switch (role)
            {
                ...
                case "fireworks":
                case "fw":
                    Utils.SendMessage(Utils.getRoleName(CustomRoles.FireWorks) + getString("FireWorksInfoLong"));
                    break;
