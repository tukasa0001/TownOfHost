    ...
    class ChatCommands
    {
        ...
        public static void getRolesInfo(string role)
        {
            switch (role)
            {
                ...
                case "sniper":
                case "snp":
                    Utils.SendMessage(Utils.getRoleName(CustomRoles.Sniper) + getString("SniperInfoLong"));
                    break;
