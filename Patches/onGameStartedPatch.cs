    ...
    class SelectRolesPatch {
        public static void Prefix(RoleManager __instance) {
            ...
            if(!main.IsHideAndSeek) {
                ...
                int AdditionalShapeshifterNum = main.MafiaCount + main.SerialKillerCount + main.BountyHunterCount;
        ...
        public static void Postfix(RoleManager __instance) {
            ...
            if(main.IsHideAndSeek) {
                ...
                int ShapeshifterNum = roleOpt.GetNumPerGame(RoleTypes.Shapeshifter);
                ShapeshifterNum -= main.MafiaCount + main.SerialKillerCount + main.BountyHunterCount;
