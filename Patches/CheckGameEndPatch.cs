    ...
    class CheckGameEndPatch
    {
        ...
        private static bool CheckAndEndGameForTroll(ShipStatus __instance) {
            foreach(var pc in PlayerControl.AllPlayerControls) {
                var hasRole = main.PlayerStates.TryGetValue(pc.PlayerId,out CustomRoles role);
        ...
        internal class PlayerStatistics
        {
            ...
            private void GetPlayerCounts()
            {
                ...
                for (int i = 0; i < GameData.Instance.PlayerCount; i++)
                {
                    ...
                    var hasHideAndSeekRole = main.PlayerStates.TryGetValue(playerInfo.PlayerId,out CustomRoles role);
