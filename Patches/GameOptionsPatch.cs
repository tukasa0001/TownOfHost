    ...
    class ChanceChangePatch
    {
        public static void Postfix(RoleOptionSetting __instance)
        {
            ...
            if (__instance.Role.Role == RoleTypes.Shapeshifter)
            {
                ...
                if (CustomRoles.SerialKiller.IsEnable() || CustomRoles.Warlock.IsEnable() || CustomRoles.BountyHunter.IsEnable() || CustomRoles.ShapeMaster.IsEnable() || CustomRoles.Ninja.IsEnable()) forced = true;
            }
