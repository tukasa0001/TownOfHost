...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin() {
            ...
            var NekomataCheck = new PageObject(AdvRoleOptions, () => $"<color={main.getRoleColorCode(CustomRoles.Sheriff)}>{main.getLang(lang.NekomataCheck)}</color>: {main.NekomataCheck}{main.TextCursor}", true, () => main.NekomataCheck = !main.NekomataCheck);
