...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin() {
            ...
            var MadGuardianTaskOptions = new PageObject(OverrideTaskCount, CustomRoles.MadGuardian);
            ...
            var TerroristTaskOptions = new PageObject(OverrideTaskCount, CustomRoles.Terrorist);
            ...
            var SnitchTaskOptions = new PageObject(OverrideTaskCount, CustomRoles.Snitch);
