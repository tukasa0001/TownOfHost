...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin() {
            ...
            var isMadmteVisionAsImpostor = new PageObject(AdvRoleOptions, () => $"<color={main.getRoleColorCode(CustomRoles.Madmate)}>{main.getLang(lang.isMadmateVisionAsImpostor)}</color>: {main.getOnOff(main.isMadmateVisionAsImpostor)}", true, () => main.isMadmateVisionAsImpostor = !main.isMadmateVisionAsImpostor);
            ...
            var NekomataCheck = new PageObject(AdvRoleOptions, () => $"<color={main.getRoleColorCode(CustomRoles.Sheriff)}>{main.getLang(lang.NekomataCheck)}</color>: {main.getOnOff(main.NekomataCheck)}", true, () => main.NekomataCheck = !main.NekomataCheck);
            var CanMakeMadmateCount = new PageObject(AdvRoleOptions, () => $"<color={main.getRoleColorCode(CustomRoles.Vampire)}>{main.getLang(lang.CanMakeMadmateCount)}</color>: {main.CanMakeMadmateCount}{main.TextCursor}", true, () => {main.CanMakeMadmateCount = 0;}, (n) => main.ChangeInt(ref main.CanMakeMadmateCount, n, 999));
            ...
            var SerialKillerCooldownDiscount = new PageObject(AdvRoleOptions, () => $"<color={main.getRoleColorCode(CustomRoles.SerialKiller)}>{main.getLang(lang.SerialKillerCooldownDiscount)}</color>(%): {main.SerialKillerCooldownDiscount}{main.TextCursor}", true, () => {main.SerialKillerCooldownDiscount = 1;}, (n) => main.ChangeInt(ref main.SerialKillerCooldownDiscount, n, 100));
