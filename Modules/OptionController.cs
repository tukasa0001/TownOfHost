...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin() {
            ...
            var LastImpostorKillCooldown = new PageObject(AdvImpostorRoleOptions, () => $"<color={Utils.getRoleColorCode(CustomRoles.Impostor)}>{getString("LastImpostorKillCooldown")}</color>(s): {Options.LastImpostorKillCooldown}{main.TextCursor}", true, () => {Options.LastImpostorKillCooldown = 0;}, (n) => Utils.ChangeInt(ref Options.LastImpostorKillCooldown, n, 180));
