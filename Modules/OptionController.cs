...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin()
        {
            ...
            var SchrodingerCatBeforeTheChangeCanWinAsACrewmateTeam = new PageObject(AdvCrewmateRoleOptions, () => $"<color={Utils.getRoleColorCode(CustomRoles.SchrodingerCat)}>{getString("SchrodingerCatBeforeTheChangeCanWinAsACrewmateTeam")}</color>: {Utils.getOnOff(Options.SchrodingerCatBeforeTheChangeCanWinAsACrewmateTeam.GetBool())}", true, () => {});
