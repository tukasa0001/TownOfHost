...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin() {
            ...
            var MadGuardianTaskOptions = new PageObject(OverrideTaskCount, main.getRoleName(CustomRoles.MadGuardian));
            var MadGuardianTask_doOverride = new PageObject(MadGuardianTaskOptions, () => main.getLang(lang.doOverride).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.MadGuardian)}>{main.getRoleName(CustomRoles.MadGuardian)}</color>"), true, () => main.MadGuardianTasksData.doOverride = !main.MadGuardianTasksData.doOverride);
            var MadGuardianTask_hasCommonTasks = new PageObject(MadGuardianTaskOptions, () => main.getLang(lang.hasCommonTasks).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.MadGuardian)}>{main.getRoleName(CustomRoles.MadGuardian)}</color>"), true, () => main.MadGuardianTasksData.hasCommonTasks = !main.MadGuardianTasksData.hasCommonTasks);
            var MadGuardianTask_LongTasksNum = new PageObject(MadGuardianTaskOptions, () => main.getLang(lang.roleLongTasksNum).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.MadGuardian)}>{main.getRoleName(CustomRoles.MadGuardian)}</color>"), true, () => main.MadGuardianTasksData.NumLongTasks = 0, n => main.ChangeInt(ref main.MadGuardianTasksData.NumLongTasks, n, 99));
            var MadGuardianTask_ShortTasksNum = new PageObject(MadGuardianTaskOptions, () => main.getLang(lang.roleShortTasksNum).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.MadGuardian)}>{main.getRoleName(CustomRoles.MadGuardian)}</color>"), true, () => main.MadGuardianTasksData.NumShortTasks = 0, n => main.ChangeInt(ref main.MadGuardianTasksData.NumShortTasks, n, 99));

            var TerroristTaskOptions = new PageObject(OverrideTaskCount, main.getRoleName(CustomRoles.Terrorist));
            var TerroristTask_doOverride = new PageObject(TerroristTaskOptions, () => main.getLang(lang.doOverride).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.Terrorist)}>{main.getRoleName(CustomRoles.Terrorist)}</color>"), true, () => main.TerroristTasksData.doOverride = !main.TerroristTasksData.doOverride);
            var TerroristTask_hasCommonTasks = new PageObject(TerroristTaskOptions, () => main.getLang(lang.hasCommonTasks).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.Terrorist)}>{main.getRoleName(CustomRoles.Terrorist)}</color>"), true, () => main.TerroristTasksData.hasCommonTasks = !main.TerroristTasksData.hasCommonTasks);
            var TerroristTask_LongTasksNum = new PageObject(TerroristTaskOptions, () => main.getLang(lang.roleLongTasksNum).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.Terrorist)}>{main.getRoleName(CustomRoles.Terrorist)}</color>"), true, () => main.TerroristTasksData.NumLongTasks = 0, n => main.ChangeInt(ref main.TerroristTasksData.NumLongTasks, n, 99));
            var TerroristTask_ShortTasksNum = new PageObject(TerroristTaskOptions, () => main.getLang(lang.roleShortTasksNum).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.Terrorist)}>{main.getRoleName(CustomRoles.Terrorist)}</color>"), true, () => main.TerroristTasksData.NumShortTasks = 0, n => main.ChangeInt(ref main.TerroristTasksData.NumShortTasks, n, 99));

            var SnitchTaskOptions = new PageObject(OverrideTaskCount, main.getRoleName(CustomRoles.Snitch));
            var SnitchTask_doOverride = new PageObject(SnitchTaskOptions, () => main.getLang(lang.doOverride).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.Snitch)}>{main.getRoleName(CustomRoles.Snitch)}</color>"), true, () => main.SnitchTasksData.doOverride = !main.SnitchTasksData.doOverride);
            var SnitchTask_hasCommonTasks = new PageObject(SnitchTaskOptions, () => main.getLang(lang.hasCommonTasks).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.Snitch)}>{main.getRoleName(CustomRoles.Snitch)}</color>"), true, () => main.SnitchTasksData.hasCommonTasks = !main.SnitchTasksData.hasCommonTasks);
            var SnitchTask_LongTasksNum = new PageObject(SnitchTaskOptions, () => main.getLang(lang.roleLongTasksNum).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.Snitch)}>{main.getRoleName(CustomRoles.Snitch)}</color>"), true, () => main.SnitchTasksData.NumLongTasks = 0, n => main.ChangeInt(ref main.SnitchTasksData.NumLongTasks, n, 99));
            var SnitchTask_ShortTasksNum = new PageObject(SnitchTaskOptions, () => main.getLang(lang.roleShortTasksNum).Replace("%role%", $"<color={main.getRoleColorCode(CustomRoles.Snitch)}>{main.getRoleName(CustomRoles.Snitch)}</color>"), true, () => main.SnitchTasksData.NumShortTasks = 0, n => main.ChangeInt(ref main.SnitchTasksData.NumShortTasks, n, 99));
