...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin() {
            ...
            //クルー役職の詳細設定
            var AdvRoleOptionsCrewmate = new PageObject(RoleOptions, lang.AdvancedRoleOptionsCrewmate);
            var SabotageMasterSkillLimit = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.SabotageMaster)}>{main.getLang(lang.SabotageMasterSkillLimit)}</color>: {main.SabotageMasterSkillLimit}{main.TextCursor}", true, () => {main.SabotageMasterSkillLimit = 0;}, (n) => main.ChangeInt(ref main.SabotageMasterSkillLimit, n, 999));
            var SabotageMasterFixesDoors = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.SabotageMaster)}>{main.getLang(lang.SabotageMasterFixesDoors)}</color>: {main.getOnOff(main.SabotageMasterFixesDoors)}", true, () => main.SabotageMasterFixesDoors = !main.SabotageMasterFixesDoors);
            var SabotageMasterFixesReactors = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.SabotageMaster)}>{main.getLang(lang.SabotageMasterFixesReactors)}</color>: {main.getOnOff(main.SabotageMasterFixesReactors)}", true, () => main.SabotageMasterFixesReactors = !main.SabotageMasterFixesReactors);
            var SabotageMasterFixesOxygens = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.SabotageMaster)}>{main.getLang(lang.SabotageMasterFixesOxygens)}</color>: {main.getOnOff(main.SabotageMasterFixesOxygens)}", true, () => main.SabotageMasterFixesOxygens = !main.SabotageMasterFixesOxygens);
            var SabotageMasterFixesComms = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.SabotageMaster)}>{main.getLang(lang.SabotageMasterFixesCommunications)}</color>: {main.getOnOff(main.SabotageMasterFixesCommunications)}", true, () => main.SabotageMasterFixesCommunications = !main.SabotageMasterFixesCommunications);
            var SabotageMasterFixesElectrical = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.SabotageMaster)}>{main.getLang(lang.SabotageMasterFixesElectrical)}</color>: {main.getOnOff(main.SabotageMasterFixesElectrical)}", true, () => main.SabotageMasterFixesElectrical = !main.SabotageMasterFixesElectrical);
            var SheriffCanKillJester = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.Sheriff)}>{main.getLang(lang.SheriffCanKillJester)}</color>: {main.getOnOff(main.SheriffCanKillJester)}", true, () => main.SheriffCanKillJester = !main.SheriffCanKillJester);
            var SheriffCanKillTerrorist = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.Sheriff)}>{main.getLang(lang.SheriffCanKillTerrorist)}</color>: {main.getOnOff(main.SheriffCanKillTerrorist)}", true, () => main.SheriffCanKillTerrorist = !main.SheriffCanKillTerrorist);
            var SheriffCanKillOpportunist = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.Sheriff)}>{main.getLang(lang.SheriffCanKillOpportunist)}</color>: {main.getOnOff(main.SheriffCanKillOpportunist)}", true, () => main.SheriffCanKillOpportunist = !main.SheriffCanKillOpportunist);
            var MayorAdditionalVote = new PageObject(AdvRoleOptionsCrewmate, () => $"<color={main.getRoleColorCode(CustomRoles.Mayor)}>{main.getLang(lang.MayorAdditionalVote)}</color>: {main.MayorAdditionalVote}{main.TextCursor}", true, () => {main.MayorAdditionalVote = 0;}, (n) => main.ChangeInt(ref main.MayorAdditionalVote, n, 99));
            
            
            //インポスター役職の詳細設定
            var AdvRoleOptionsImpostor = new PageObject(RoleOptions, lang.AdvancedRoleOptionsImpostor);
            ...
            var SerialKillerCooldownDiscount = new PageObject(AdvRoleOptionsImpostor, () => $"<color={main.getRoleColorCode(CustomRoles.SerialKiller)}>{main.getLang(lang.SerialKillerCooldownDiscount)}</color>(%): {main.SerialKillerCooldownDiscount}{main.TextCursor}", true, () => {main.SerialKillerCooldownDiscount = 0;}, (n) => main.ChangeInt(ref main.SerialKillerCooldownDiscount, n, 100));
