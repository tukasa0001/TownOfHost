...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin()
        {
            ...
            var DefaultShapeshiftCooldown = new PageObject(AdvImpostorRoleOptions, () => $"<color={Utils.getRoleColorCode(CustomRoles.Warlock)}>{getString("DefaultShapeshiftCooldown")}</color>(s): {Options.DefaultShapeshiftCooldown}{main.TextCursor}", true, () => { Options.DefaultShapeshiftCooldown = 0; }, (n) => Utils.ChangeInt(ref Options.DefaultShapeshiftCooldown, n, 999));
