...
namespace TownOfHost
{
    static class CustomOptionController
    {
        ...
        public static void begin() {
            ...
            var MadmateHasImpostorVision = new PageObject(AdvRoleOptions, () => $"<color={main.getRoleColorCode(CustomRoles.Madmate)}>{main.getLang(lang.MadmateHasImpostorVision)}</color>: {main.getOnOff(main.MadmateHasImpostorVision)}", true, () => { main.MadmateHasImpostorVision = !main.MadmateHasImpostorVision; });
