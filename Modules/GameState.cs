...
namespace TownOfHost
{
    public static class PlayerState
    {
        ...
        public static void RpcsetCondition(this byte player)
        {
            MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.SetCondition, SendOption.Reliable, -1);
            writer.Write(player);
