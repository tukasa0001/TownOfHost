...
namespace TownOfHost
{
    ...
    public static class GameStates
    {
        ...
        public static bool IsOnlineGame => AmongUsClient.Instance.NetworkModes == NetworkModes.OnlineGame;
        public static bool IsLocalGame => AmongUsClient.Instance.NetworkModes == NetworkModes.LocalGame;
        public static bool IsFreePlay => AmongUsClient.Instance.NetworkModes == NetworkModes.FreePlay;
