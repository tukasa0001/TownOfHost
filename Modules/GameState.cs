...
namespace TownOfHost
{
    ...
    public static class GameStates
    {
        ...
        public static bool IsOnlineGame => AmongUsClient.Instance.GameMode == NetworkModes.OnlineGame;
        public static bool IsLocalGame => AmongUsClient.Instance.GameMode == NetworkModes.LocalGame;
        public static bool IsFreePlay => AmongUsClient.Instance.GameMode == NetworkModes.FreePlay;
