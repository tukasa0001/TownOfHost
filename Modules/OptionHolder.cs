...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        public static void Load()
        {
            ...
            SheriffCanKillNeutrals = CustomOption.Create(20412, Color.white, "SheriffCanKillNeutrals", true, CustomRoleSpawnChances[CustomRoles.Sheriff]);
            SheriffCanKillCrewmatesAsIt = CustomOption.Create(20413, Color.white, "SheriffCanKillCrewmatesAsIt", false, CustomRoleSpawnChances[CustomRoles.Sheriff]);
            SheriffShotLimit = CustomOption.Create(20414, Color.white, "SheriffShotLimit", 15, 1, 15, 1, CustomRoleSpawnChances[CustomRoles.Sheriff]);
