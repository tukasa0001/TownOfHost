...
namespace TownOfHost
{
    public static class BountyHunter
    {
        ...
        {
            Options.SetupRoleOptions(Id, CustomOption.CustomOptionType.Impostor, CustomRoles.BountyHunter);
            TargetChangeTime = CustomOption.Create(Id + 10, CustomOption.CustomOptionType.Impostor, Color.white, "BountyTargetChangeTime", 60f, 10f, 900f, 2.5f, Options.CustomRoleSpawnChances[CustomRoles.BountyHunter]);
            SuccessKillCooldown = CustomOption.Create(Id + 11, CustomOption.CustomOptionType.Impostor, Color.white, "BountySuccessKillCooldown", 2.5f, 0f, 180f, 2.5f, Options.CustomRoleSpawnChances[CustomRoles.BountyHunter]);
            FailureKillCooldown = CustomOption.Create(Id + 12, CustomOption.CustomOptionType.Impostor, Color.white, "BountyFailureKillCooldown", 50f, 0f, 180f, 2.5f, Options.CustomRoleSpawnChances[CustomRoles.BountyHunter]);
        }
