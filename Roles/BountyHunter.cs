...
namespace TownOfHost
{
    public static class BountyHunter
    {
        ...
        private static CustomOption ShowTargetArrow;
        ...
        public static void SetupCustomOption()
        {
            ...
            ShowTargetArrow = CustomOption.Create(Id + 13, TabGroup.ImpostorRoles, Color.white, "BountyShowTargetArrow", false, Options.CustomRoleSpawnChances[CustomRoles.BountyHunter]);
        }
        ...
        public static string PCGetTargetArrow(PlayerControl seer, PlayerControl target)
        {
            ...
            foreach (var pc in PlayerControl.AllPlayerControls)
            {
                ...
                if (BountyTarget) arrow = Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Impostor), arrow);
                if (target.AmOwner)
                {
                    //MODなら矢印表示
                    Suffix += arrow;
