...
namespace TownOfHost
{
    public static class Mare
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            SpeedInLightsOut = CustomOption.Create(Id + 10, TabGroup.ImpostorRoles, Color.white, "MareAddSpeedInLightsOut", 0.3f, 0.1f, 0.5f, 0.1f, Options.CustomRoleSpawnChances[CustomRoles.Mare], format: "FormatMultiplier");
            KillCooldownInLightsOut = CustomOption.Create(Id + 11, TabGroup.ImpostorRoles, Color.white, "MareKillCooldownInLightsOut", 15f, 2.5f, 180f, 2.5f, Options.CustomRoleSpawnChances[CustomRoles.Mare], format: "FormatSeconds");
        }
