...
public static class SerialKiller
{
    ...
    public static void SetupCustomOption()
    {
        ...
        TimeLimit = FloatOptionItem.Create(Id + 11, "SerialKillerLimit", new(2.5f, 999f, 5f), 60f, TabGroup.ImpostorRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.SerialKiller])
            .SetValueFormat(OptionFormat.Seconds);
    }
