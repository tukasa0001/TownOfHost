...
namespace TownOfHost
{
    public static class SerialKiller
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            KillCooldown = CustomOption.Create(Id + 10, TabGroup.ImpostorRoles, Color.white, "KillCooldown", 20f, 2.5f, 180f, 2.5f, Options.CustomRoleSpawnChances[CustomRoles.SerialKiller], format: "FormatSeconds");
            TimeLimit = CustomOption.Create(Id + 11, TabGroup.ImpostorRoles, Color.white, "SerialKillerLimit", 60f, 5f, 900f, 5f, Options.CustomRoleSpawnChances[CustomRoles.SerialKiller], format: "FormatSeconds");
        }
