...
namespace TownOfHost
{
    public static class TimeManager
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            MeetingTimeLimit = CustomOption.Create(Id + 11, TabGroup.CrewmateRoles, Color.white, "TimeManagerLimitMeetingTime", 300, 150, 500, 1, Options.CustomRoleSpawnChances[CustomRoles.TimeManager]);
        }
