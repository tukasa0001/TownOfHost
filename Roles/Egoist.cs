...
namespace TownOfHost
{
    public static class Egoist
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            KillCooldown = CustomOption.Create(Id + 10, TabGroup.NeutralRoles, Color.white, "KillCooldown", 20f, 2.5f, 180f, 2.5f, Options.CustomRoleSpawnChances[CustomRoles.Egoist], format: "FormatSeconds");
        }
