...
namespace TownOfHost
{
    public static class TimeThief
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            TimeThiefDecreaseMeetingTime = CustomOption.Create(Id + 10, Color.white, "TimeThiefDecreaseMeetingTime", 20, 0, 100, 1, Options.CustomRoleSpawnChances[CustomRoles.TimeThief]);
            TimeThiefLowerLimitVotingTime = CustomOption.Create(Id + 11, Color.white, "TimeThiefLowerLimitVotingTime", 10, 1, 300, 1, Options.CustomRoleSpawnChances[CustomRoles.TimeThief]);
            TimeThiefReturnStolenTimeUponDeath = CustomOption.Create(Id + 12, Color.white, "TimeThiefReturnStolenTimeUponDeath", true, Options.CustomRoleSpawnChances[CustomRoles.TimeThief]);
        }
