...
namespace TownOfHost
{
    public static class SabotageMaster
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            SkillLimit = CustomOption.Create(Id + 10, TabGroup.CrewmateRoles, Color.white, "SabotageMasterSkillLimit", 1, 0, 99, 1, Options.CustomRoleSpawnChances[CustomRoles.SabotageMaster], format: "FormatTimes");
