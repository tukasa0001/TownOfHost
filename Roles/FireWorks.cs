                ...
                case FireWorksState.ReadyFire:
                    ...
                    foreach (PlayerControl target in PlayerControl.AllPlayerControls)
                    {
                        ...
                        foreach (var pos in fireWorksPosition[pc.PlayerId])
                        {
                            ...
                            {
                                Main.PlayerStates[target.PlayerId].SetDeathReason(PlayerState.DeathReason.Bombed);
                    ...
                    if (suicide)
                    {
                        ...
                        if (totalAlive != 1)
                        {
                            Main.PlayerStates[pc.PlayerId].SetDeathReason(PlayerState.DeathReason.Misfire);
