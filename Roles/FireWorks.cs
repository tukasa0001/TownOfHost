...
namespace TownOfHost
{
    public static class FireWorks
    {
        ...
        {
            Options.SetupRoleOptions(Id, CustomOption.CustomOptionType.Impostor, CustomRoles.FireWorks);
            FireWorksCount = CustomOption.Create(Id + 10, CustomOption.CustomOptionType.Impostor, Color.white, "FireWorksMaxCount", 1f, 1f, 3f, 1f, Options.CustomRoleSpawnChances[CustomRoles.FireWorks]);
            FireWorksRadius = CustomOption.Create(Id + 11, CustomOption.CustomOptionType.Impostor, Color.white, "FireWorksRadius", 1f, 0.5f, 3f, 0.5f, Options.CustomRoleSpawnChances[CustomRoles.FireWorks]);
        }
