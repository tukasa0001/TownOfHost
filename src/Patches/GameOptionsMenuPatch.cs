    ...
    public static class GameOptionsMenuPatch
    {
        public static void Postfix(GameOptionsMenu __instance)
        {
            ...
            foreach (var tab in Enum.GetValues(typeof(TabGroup)))
            {
                ...
                Logger.Msg("Tab Icon: " + tab, "Loading Tab " + tab);
                tohTab.transform.FindChild("Hat Button").FindChild("Icon").GetComponent<SpriteRenderer>().sprite = Helpers.LoadSpriteFromResources($"TownOfHost.assets.TabIcon_{tab}.png", 100f);
                tabs.Add(tohTab);
