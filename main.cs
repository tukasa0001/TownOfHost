    ...
    public class main : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            JapaneseTexts = new Dictionary<lang, string>(){
                ...
                {lang.MadSnitchInfoLong, "マッドスニッチ:\nインポスター陣営に属するが、誰が仲間かはわからない。インポスターからもマッドスニッチが誰なのかはわからない。タスクを完了させるとインポスターの名前が赤色に変化する。ベントに入れることができないが、インポスターと視界の範囲が同じになっている。"},
            ...
            EnglishTexts = new Dictionary<lang, string>(){
                ...
                {lang.MadSnitchInfoLong, "MadSnitch:\nイインポスター陣営に属するが、誰が仲間かはわからない。ImpostorからもMadSnitchが誰なのかはわからない。タスクを完了させるとインポスターの名前が赤色に変化する。ベントに入れることができないが、Impostorと視界の範囲が同じになっている。"},
