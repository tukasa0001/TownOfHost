    ...
    public class main : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            JapaneseTexts = new Dictionary<lang, string>(){
                ...
                {lang.SheriffInfoLong, "シェリフ:\nクルー以外をkillできるクルーメイト役職。\nクルーメイトをキルすると自殺する。\nタスクはない。"},
                {lang.BountyHunterInfoLong, "バウンティハンター:\n標的をkillすると次のｷﾙｸｰﾙが半分になるｲﾝﾎﾟｽﾀｰ\nﾀｰｹﾞｯﾄ(標的)は自身の名前の上に表示される\nﾀｰｹﾞｯﾄ以外をkillしてもｷﾙｸｰﾙは減らない。"},
                {lang.WitchInfoLong, "魔女:\n魔術をかけ,会議後で殺す事ができるｲﾝﾎﾟｽﾀｰ\nkillﾎﾞﾀﾝで「kill」と「spell：魔術」が変わる。\n会議で「s」マークが付き魔術をかけられた人は魔女を追放しなければ会議後に死亡する。"},
