    ...
    public class main : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            JapaneseTexts = new Dictionary<lang, string>(){
                ...
                {lang.SnitchInfoLong, "スニッチ:\nタスク完了と同時にインポスターの名前の色が赤く表示される。(※誰が人狼かわかる!!!)\n逆に自身のタスクが少なくなると\nインポスターに自身がスニッチだとバレる。"},
