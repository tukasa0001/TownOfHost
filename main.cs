    ...
    public class main : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            JapaneseTexts = new Dictionary<lang, string>(){
                ...
                {lang.MadmateInfoLong, "マッドメイト:\nキル＆サボタージュは不可能なインポスター。\nｲﾝﾎﾟｽﾀｰもﾏｯﾄﾞﾒｲﾄも互いにわからない。\nベントは使用可能。「タスクはない。」"},
                {lang.MadGuardianInfoLong, "マッドガーディアン:\nキル＆サボタージュは不可能なインポスター。\nｲﾝﾎﾟｽﾀｰもﾏｯﾄﾞｶﾞｰﾃﾞｨｱﾝも互いにわからない。\nベントは使用不可能。「タスクがあります。」完了するとｼｰﾙﾄﾞが付与される。(ｷﾙされない。)"},
                {lang.BaitInfoLong, "ベイト:\nキルされた時に、自分をキルした人を\n強制的なセルフレポートさせるクルーメイト。"},
                {lang.TerroristInfoLong, "テロリスト:\n自身のタスクを全て完了させた状態で\n死亡した時に単独勝利する第三陣営役職。\n　　 ※死因は「キル・追放」どちらでもよい。タスクを完了せずに死亡or試合が終了は敗北。"},
                {lang.MafiaInfoLong, "マフィア:\n仲間が全員死亡後にキルが可能になるｲﾝﾎﾟｽﾀｰ。\n初期状態はﾍﾞﾝﾄ・ｻﾎﾞﾀｰｼﾞｭ・変身が可能。"},
                {lang.VampireInfoLong, "ヴァンパイア:\n遅延キルが可能なインポスター。\n(ｷﾙﾎﾞﾀﾝを押してから数秒後にｷﾙが発生する。)\nｷﾙﾎﾞﾀﾝを押してｷﾙ発生より前に会議が始まると会議のサイレンと同時にｷﾙが発生する。"},
                {lang.SabotageMasterInfoLong, "サボタージュマスター:\nﾘｱｸﾀｰ・o2・MIRA HQの通信妨害は片方直せば一人で修理可能なクルーメイト。\n停電は一箇所のレバーに触れる事で全て直る。\nドアを開けるとその部屋の全てのドアが開く。"},
                {lang.MayorInfoLong, "メイヤー:\n票を複数持ち,まとめて一人またはskipに\n入れることができるクルーメイト。(設定有)"},
                {lang.OpportunistInfoLong, "オポチュニスト:\n追加勝利する事ができる第三陣営役職。\nゲーム終了時に生きていれば追加勝利。\nタスクはない。"},
                {lang.SnitchInfoLong, "スニッチ:\nタスク完了する事で役に立てるクルーメイト。タスク完了と同時にインポスターの名前の色が\n赤く表示され逆に自身のタスクが少なくなると\n名前の横に★が表示されｲﾝﾎﾟｽﾀｰにｽﾆｯﾁとバレる"},
                {lang.SheriffInfoLong, "シェリフ:\nクルー以外をキルできるクルーメイト役職。\nクルーメイトをキルすると自殺する。\nタスクはない。"},
                {lang.BountyHunterInfoLong, "バウンティハンター:\n標的をｷﾙし,次のｷﾙｸｰﾙを半分にできるｲﾝﾎﾟｽﾀｰ。\nﾀｰｹﾞｯﾄ(標的)は自身の名前の上に表示される。(MOD導入者は画面下部に表示される。)\nﾀｰｹﾞｯﾄ以外をキルしてもｷﾙｸｰﾙは減らない。"},
                {lang.WitchInfoLong, "魔女:\n魔術をかけ,会議後に殺す事ができるｲﾝﾎﾟｽﾀｰ。\nｷﾙﾎﾞﾀﾝで「kill」と「spell：魔術」が変わる。\n魔術をかけられた人は会議で「†」マｰクが付き魔女を追放しなければ会議後に死亡する。"},
